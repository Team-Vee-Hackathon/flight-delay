    ...
    <div className='h-[130vh] main-body'>
      ...
      <div className="mt-[9rem]">
        <div className="flex items-center gap-2 justify-center">
            ...
            <Image height={300}  width={300} className="h-[20px]" src={ZKPasPic} alt="" />
        </div>
        <div>
        ...
        <div className="transparent  flex items-center justify-center mb-2 px-6 p-1 rounded-[30px] mt-[10rem] ml-[35rem] ">
